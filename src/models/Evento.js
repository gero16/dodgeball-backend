  ...
  datosEspecificos: {
    ...
    liga: {
      ...
      estadisticasLiga: [{
        ...
        porcentajePonchado: { type: Number, default: 0 },
        indiceAtaque: { type: Number, default: 0 },
        indiceDefensa: { type: Number, default: 0 },
        poderLiga: { type: Number, default: 0 },
        poderPromedioPartido: { type: Number, default: 0 },
        poderPromedioPartidoAjustado: { type: Number, default: 0 },
        tirosPorSet: { type: Number, default: 0 },
        hitsPorSet: { type: Number, default: 0 },
        quemadosPorSet: { type: Number, default: 0 },
        asistenciasPorSet: { type: Number, default: 0 },
        tirosRecibidosPorSet: { type: Number, default: 0 },
        hitsRecibidosPorSet: { type: Number, default: 0 },
        esquivesPorSet: { type: Number, default: 0 },
        ponchadoPorSet: { type: Number, default: 0 },
        catchesPorSet: { type: Number, default: 0 },
        bloqueosPorSet: { type: Number, default: 0 },
        catchesRecibidosPorSet: { type: Number, default: 0 }
      }],
      partidos: [{
        fecha: Date,
        equipoLocal: String,
