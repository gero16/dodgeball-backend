...
const jugadoresFaltantes = [
  {
    ...
    apellido: 'Yanes',
    equipo: 'LA NEOFARAFA',
    email: 'patricia.yanes.estadisticas@email.com',
    numeroCamiseta: 7,
    posicion: 'versatil',
    setsJugados: 9,
    tirosTotales: 15,
  ...
  },
  {
    ...
    apellido: 'Arboleda',
    equipo: 'LA NEOFARAFA',
    email: 'josue.arboleda.estadisticas@email.com',
    numeroCamiseta: 8,
    posicion: 'versatil',
    setsJugados: 8,
    tirosTotales: 21,
  ...
  },
  {
    ...
    email: 'matheo.santos.estadisticas@email.com',
    numeroCamiseta: 9,
    posicion: 'versatil',
    setsJugados: 11,
    tirosTotales: 8,
  ...
  },
  {
    ...
    apellido: 'Burrera',
    equipo: 'BUMBA',
    email: 'diego.burrera.estadisticas@email.com',
    numeroCamiseta: 11,
    posicion: 'versatil',
    setsJugados: 9,
    tirosTotales: 29,
  ...
  },
  {
    ...
    apellido: 'Pérez',
    equipo: 'LA NEOFARAFA',
    email: 'rodrigo.perez.estadisticas@email.com',
    numeroCamiseta: 12,
    posicion: 'versatil',
    setsJugados: 10,
    tirosTotales: 16,
  ...
  },
  {
    ...
    apellido: 'Pereira',
    equipo: 'THE DODGEBALL MONKEYS',
    email: 'tiago.pereira.estadisticas@email.com',
    numeroCamiseta: 13,
    posicion: 'versatil',
    setsJugados: 11,
    tirosTotales: 18,
  ...
  },
  {
    ...
    apellido: 'Alonso',
    equipo: 'THE CATCHERS',
    email: 'facundo.alonso.estadisticas@email.com',
    numeroCamiseta: 14,
    posicion: 'versatil',
    setsJugados: 9,
    tirosTotales: 19,
  ...
  },
  {
    ...
    apellido: 'Rodríguez',
    equipo: 'THE DODGEBALL MONKEYS',
    email: 'ignacio.rodriguez.estadisticas@email.com',
    numeroCamiseta: 15,
    posicion: 'versatil',
    setsJugados: 11,
    tirosTotales: 4,
  ...
  },
  {
    ...
    apellido: 'Gil',
    equipo: 'LA NEOFARAFA',
    email: 'santiago.gil.estadisticas@email.com',
    numeroCamiseta: 16,
    posicion: 'versatil',
    setsJugados: 8,
    tirosTotales: 2,
  ...
  },
  {
    ...
    apellido: 'Sogliano',
    equipo: 'LA NEOFARAFA',
    email: 'agustin.sogliano.estadisticas@email.com',
    numeroCamiseta: 17,
    posicion: 'versatil',
    setsJugados: 9,
    tirosTotales: 7,
  ...
  },
  {
    ...
    apellido: 'Alonso',
    equipo: 'THE CATCHERS',
    email: 'mateo.alonso.estadisticas@email.com',
    numeroCamiseta: 18,
    posicion: 'versatil',
    setsJugados: 9,
    tirosTotales: 6,
  ...
  },
  {
    ...
    apellido: '',
    equipo: 'BUMBA',
    email: 'pastor.estadisticas@email.com',
    numeroCamiseta: 19,
    posicion: 'versatil',
    setsJugados: 9,
    tirosTotales: 4,
  ...
  },
  {
    ...
    apellido: 'Barreiro',
    equipo: 'BUMBA',
    email: 'santino.barreiro.estadisticas@email.com',
    numeroCamiseta: 20,
    posicion: 'versatil',
    setsJugados: 9,
    tirosTotales: 5,
...
async function crear12Jugadores() {
  try {
    console.log('🔄 Creando los 12 jugadores faltantes...\n');
    ...
    for (const jugador of jugadoresFaltantes) {
      ...
      try {
        ...
        const jugadorPerfil = jugadorResponse.data.data;
        ...
        if (error.response?.data?.message) {
          console.error(`   📝 Detalle: ${error.response.data.message}`);
        }
        errores++;
      }
    }
