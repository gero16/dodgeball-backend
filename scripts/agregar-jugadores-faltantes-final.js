...
// Jugadores faltantes con emails únicos
const jugadoresFaltantes = [
  {
    ...
    numeroCamiseta: 4,
    posicion: 'versatil',
    email: 'diego.burrera.nuevo@email.com',
    estadisticas: {
      setsJugados: 9,
      tirosTotales: 29,
      hits: 7,
  ...
  },
  {
    ...
    numeroCamiseta: 6,
    posicion: 'versatil',
    email: 'santino.barreiro.nuevo@email.com',
    estadisticas: {
      setsJugados: 9,
      tirosTotales: 5,
      hits: 0,
  ...
  },
  {
    ...
    numeroCamiseta: 10,
    posicion: 'versatil',
    email: 'matheo.santos.nuevo@email.com',
    estadisticas: {
      setsJugados: 11,
      tirosTotales: 8,
      hits: 2,
  ...
  },
  {
    ...
    numeroCamiseta: 12,
    posicion: 'versatil',
    email: 'ignacio.rodriguez.nuevo@email.com',
    estadisticas: {
      setsJugados: 11,
      tirosTotales: 4,
      hits: 3,
  ...
  },
  {
    ...
    numeroCamiseta: 22,
    posicion: 'versatil',
    email: 'santiago.gil.nuevo@email.com',
    estadisticas: {
      setsJugados: 8,
      tirosTotales: 2,
      hits: 0,
  ...
  },
  {
    ...
    numeroCamiseta: 23,
    posicion: 'versatil',
    email: 'agustin.sogliano.nuevo@email.com',
    estadisticas: {
      setsJugados: 9,
      tirosTotales: 7,
      hits: 2,
  ...
  },
  {
    ...
    numeroCamiseta: 16,
    posicion: 'versatil',
    email: 'mateo.alonso.nuevo@email.com',
    estadisticas: {
      setsJugados: 9,
      tirosTotales: 6,
      hits: 0,
  ...
  },
  {
    ...
    numeroCamiseta: 15,
    posicion: 'versatil',
    email: 'facundo.alonso.nuevo@email.com',
    estadisticas: {
      setsJugados: 9,
      tirosTotales: 19,
      hits: 8,
  ...
  },
  {
    ...
    numeroCamiseta: 21,
    posicion: 'versatil',
    email: 'rodrigo.perez.nuevo@email.com',
    estadisticas: {
      setsJugados: 10,
      tirosTotales: 16,
      hits: 7,
  ...
  },
  {
    ...
    numeroCamiseta: 11,
    posicion: 'versatil',
    email: 'tiago.pereira.nuevo@email.com',
    estadisticas: {
      setsJugados: 11,
      tirosTotales: 18,
      hits: 7,
  ...
  try {
    ...
    for (const jugadorData of jugadoresFaltantes) {
      try {
        ...
        await jugador.save();
        jugadoresCreados++;
        console.log(`✅ Jugador creado: ${jugadorData.nombre} ${jugadorData.apellido} - ${jugadorData.email}`);
