...
// Todos los datos que me proporcionaste
...
async function agregarTodosLosJugadores() {
  try {
    console.log('🔄 Agregando todos los jugadores con estadísticas...\n');
    ...
    for (const jugador of todosLosJugadores) {
      ...
      try {
        ...
        if (estadisticaExistente) {
          ...
          console.log(`   ✅ Actualizado - Poder: ${jugador.indicePoder}`);
          actualizados++;
        } else {
          console.log(`   ⚠️  Estadística no encontrada para ${jugador.nombre} ${jugador.apellido}. Saltando.`);
        }
      } catch (error) {
